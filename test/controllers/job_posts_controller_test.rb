...
class JobPostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create job_post" do
    assert_difference("JobPost.count") do
      post job_posts_url, params: { job_post: { job_post_describtion: @job_post.job_post_describtion, job_post_id: @job_post.job_post_id, job_post_title: @job_post.job_post_title, posted_on: @job_post.posted_on, user_id: @job_post.user_id } }
    end
  ...
  test "should update job_post" do
    patch job_post_url(@job_post), params: { job_post: { job_post_describtion: @job_post.job_post_describtion, job_post_id: @job_post.job_post_id, job_post_title: @job_post.job_post_title, posted_on: @job_post.posted_on, user_id: @job_post.user_id } }
