...
class JobApplicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create job_application" do
    assert_difference("JobApplication.count") do
      post job_applications_url, params: { job_application: { applied_on: @job_application.applied_on, job_application_id: @job_application.job_application_id, job_application_state_id: @job_application.job_application_state_id, job_post_id: @job_application.job_post_id, user_id: @job_application.user_id } }
    end
  ...
  test "should update job_application" do
    patch job_application_url(@job_application), params: { job_application: { applied_on: @job_application.applied_on, job_application_id: @job_application.job_application_id, job_application_state_id: @job_application.job_application_state_id, job_post_id: @job_application.job_post_id, user_id: @job_application.user_id } }
