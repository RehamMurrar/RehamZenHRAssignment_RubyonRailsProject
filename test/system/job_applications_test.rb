...
class JobApplicationsTest < ApplicationSystemTestCase
  ...
  test "should create job application" do
    ...
    fill_in "Job application", with: @job_application.job_application_id
    fill_in "Job application state", with: @job_application.job_application_state_id
    fill_in "Job post id", with: @job_application.job_post_id
